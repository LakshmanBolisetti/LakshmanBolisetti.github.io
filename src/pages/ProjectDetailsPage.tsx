        ...
        <div className="container mx-auto px-6">
          ...
          <div className="bg-white dark:bg-devops-dark rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="p-8">
              ...
              <div className="mb-8">
                <h2 className="text-xl font-semibold text-devops-navy dark:text-white mb-4">Technologies</h2>
                <div className="flex flex-wrap gap-2">
                  {project.technologies.map((tech, index) => (
                    <span 
                      key={index}
                      className="px-3 py-1 bg-gray-100 dark:bg-gray-800 text-devops-navy dark:text-white rounded-md"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              <div className="mb-8">
                <h2 className="text-xl font-semibold text-devops-navy dark:text-white mb-4">Project Process</h2>
              ...
              <div className="mb-8">
                <h2 className="text-xl font-semibold text-devops-navy dark:text-white mb-4">Tools Used</h2>
              ...
              <div>
                <h2 className="text-xl font-semibold text-devops-navy dark:text-white mb-4">Outcomes</h2>
                <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-200 ml-4">
