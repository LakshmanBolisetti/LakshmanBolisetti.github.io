...
const HeroSection = () => {
  ...
  const startTyping = useCallback(() => {
    ...
    const typingInterval = setInterval(() => {
      if (currentIndex <= fullText.length) {
        ...
        setTimeout(() => {
          // Instead of clearing text completely, fade it out gradually
          setTimeout(() => {
            setText('');
            startTyping();
          }, 500); // Add 0.5 second pause before starting new cycle
  ...
  return (
    <section id="home" className="pt-28 pb-16 md:pt-32 md:pb-24 bg-gradient-to-br from-sunset-skyBlue/10 to-sunset-lavender/30 dark:from-devops-background-dark dark:to-gray-900 transition-colors duration-300">
      <div className="container mx-auto px-6 flex flex-col-reverse md:flex-row items-center">
        <div className="md:w-3/5 mt-8 md:mt-0 md:pr-8 animate-fade-in">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-devops-navy dark:text-white min-h-[72px]">
            ...
            <span className="text-sunset-skyBlue">{text.slice(8)}</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a href="#contact" className="bg-white dark:bg-gray-800 hover:bg-sunset-lavender dark:hover:bg-gray-700 text-devops-navy dark:text-white px-6 py-3 rounded-md font-medium transition-all border border-gray-300 dark:border-gray-600 hover:shadow-md inline-flex items-center justify-center">
              Contact Me
            </a>
          </div>
        </div>
        <div className="md:w-2/5 flex justify-center animate-fade-in">
          <div className="w-64 h-64 md:w-72 md:h-72 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl profile-image-container">
            <img 
