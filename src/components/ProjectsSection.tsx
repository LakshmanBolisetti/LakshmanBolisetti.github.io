        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2 text-devops-navy">{project.title}</h3>
                <p className="text-gray-600 mb-4">{project.description}</p>
                
                <div className="mb-4">
                  <h4 className="text-sm font-semibold text-devops-navy mb-2">Technologies Used:</h4>
                ...
                <div className="flex gap-3 mt-4">
                  {project.github && (
                    <a 
                      ...
                      className="flex items-center gap-1 text-sm text-devops-navy hover:text-devops-accent transition-colors"
                    >
                      <Github size={16} />
